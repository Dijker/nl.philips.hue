...
module.exports = class HueApp extends Homey.App {
  ...
  onInit() {
    ...
    this.onFlowActionCLIPGeneric = this.onFlowActionCLIPGeneric.bind(this);
    ...
    this.onFlowCLIPGenericAutocomplete = this.onFlowCLIPGenericAutocomplete.bind(this);
  ...
  onInitFlow() {
    ...
    new Homey.FlowCardAction('setCLIPGenericStatus')
      .register()
      .registerRunListener( this.onFlowActionCLIPGeneric )
      .getArgument('clip_generic')
      .registerAutocompleteListener( this.onFlowCLIPGenericAutocomplete );
